...
export function buildFalPrompt(
  ...
  const joined = [
    ...
    musicDirection,
    audioDelivery,
    "Feel like a birthday celebration with tasteful party details (candles, cake, balloons, confetti, gifts, warm smiles, celebratory lighting) when they fit the scene.",
