...
**Latest commit on `main`:** [`4dca0f2`](https://github.com/RajatA98/BirthdayBot/commit/4dca0f2) — `Recompress already-cached photos before /api/plan + /api/suggest-prompt`
...
- [ops/updates](./ops/updates) — most recent: [`2026-05-10--main--4dca0f2.md`](./ops/updates/2026-05-10--main--4dca0f2.md). **If you are an AI agent picking this project up, read that file first.**
