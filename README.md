...
**Latest commit on `main`:** [`c3ef602`](https://github.com/RajatA98/BirthdayBot/commit/c3ef602) — `Cap Preview postcard to viewport + drop misleading sing-along default`
...
- [ops/updates](./ops/updates) — most recent: [`2026-05-10--main--c3ef602.md`](./ops/updates/2026-05-10--main--c3ef602.md). **If you are an AI agent picking this project up, read that file first.**
